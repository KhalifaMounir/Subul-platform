      ...
      <div className={styles.homeContent}>
        <div className={styles.heroSection}>
          ...
          <h1 className={styles.heroTitle}>
            مرحباً بك في <span className={styles.heroTitleGradient}>سبل</span>
          </h1>
          <p className={styles.heroDescription}>
            منصة التعلم الإلكتروني الرائدة التي تقدم أفضل الدورات التدريبية والمحتوى التعليمي المتميز
          </p>
        </div>
          ...
          {[
            {
              iconType: 'blue',
              title: 'تعلم تفاعلي',
              description: 'محتوى تعليمي تفاعلي مصمم خصيصاً لضمان أفضل تجربة تعلم',
              icon: (
            ...
            },
            {
              iconType: 'purple',
              title: 'مدربين خبراء',
              description: 'تعلم من أفضل المدربين والخبراء في مختلف المجالات',
              icon: (
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            ...
            },
            {
              iconType: 'green',
              title: 'شهادات معتمدة',
              description: 'احصل على شهادات معتمدة تعزز من مسيرتك المهنية',
              icon: (
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
